...
app = FastAPI(
    ...
    description="Production-ready backend ingestion API for job platforms starting with Indeed Mobile GraphQL.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
)
...
@app.get("/api/scrape/wellfound", response_model=list[JobItem], tags=["Scrapers"])
