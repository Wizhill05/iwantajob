...
export function JobsFilterBar({
  ...
  return (
    <Card className="bg-[#181818] border border-[#262626] rounded-xl p-4 md:p-5 shadow-sm space-y-4">
      ...
      <div className="flex items-center justify-between gap-3 flex-wrap border-b border-[#262626] pb-3">
        ...
        <div className="flex items-center gap-2">
          {activeCount > 0 ? (
            <Badge
              size="sm"
              className="bg-[#3ecf8e]/15 text-[#3ecf8e] border border-[#3ecf8e]/30 font-mono text-xs"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 text-xs font-mono rounded-lg bg-[#141414] border border-[#262626] text-white placeholder-[#6b7280] focus:outline-none focus:border-[#3ecf8e] transition-colors"
          />
        </div>
        ...
        <div className="relative">
          ...
          {filters.city && (
            <button
              ...
              className="absolute inset-y-0 right-0 pr-3 flex items-center text-[10px] font-mono text-[#9ca3af] hover:text-white"
            >
              Clear
            </button>
          )}
        ...
        {POPULAR_CITIES.map((c) => {
          ...
          return (
            <button
              ...
              className={cn(
                'px-2.5 py-1 rounded-md border transition-all whitespace-nowrap flex-shrink-0',
                isSelected
                  ? 'bg-[#3ecf8e]/15 border-[#3ecf8e]/40 text-[#3ecf8e] font-semibold shadow-[0_0_8px_rgba(62,207,142,0.1)]'
            ...
            {SOURCE_OPTIONS.map((opt) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'py-1.5 px-2 rounded text-[11px] font-mono transition-all text-center',
                    isSelected
      ...
      <div className="pt-2 border-t border-[#262626] space-y-2">
        <div className="flex items-center justify-between text-xs font-mono">
          <div className="flex items-center gap-1.5 text-[#9ca3af]">
            ...
            <span className="uppercase tracking-wider">Annual Compensation Floor</span>
          </div>
          <div className="flex items-center gap-2">
            <span
              className={cn(
